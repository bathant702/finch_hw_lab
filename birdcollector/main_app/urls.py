...
urlpatterns = [
    ...
    path('birds/<int:bird_id>/assoc_toy/<int:toy_id>/', views.assoc_toy, name='assoc_toy'), #has toy
    path('birds/<int:bird_id>/unassoc_toy/<int:toy_id>/', views.unassoc_toy, name='unassoc_toy'),#does not have toy
    #toy path
